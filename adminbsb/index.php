...
<body class="theme-red">
    <!-- Page Loader -->
    <?php include_once "addons/page-loader.php" ?>
    <!-- #END# Page Loader -->
    <!-- Overlay For Sidebars -->
    <div class="overlay"></div>
    <!-- #END# Overlay For Sidebars -->
    <!-- Search Bar -->
    <?php include_once "addons/searchbar.php"; ?>
    <!-- #END# Search Bar -->
    <!-- Top Bar -->
    <?php include_once "addons/topbar.php"; ?>
    <!-- #Top Bar -->
    <section>
        <!-- Left Sidebar -->
        <?php include_once "addons/left-sidebar.php"; ?>
        <!-- #END# Left Sidebar -->
        <!-- Right Sidebar -->
        <?php include_once "addons/right-sidebar.php"; ?>
        <!-- #END# Right Sidebar -->
    </section>
